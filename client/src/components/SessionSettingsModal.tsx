          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            <div role="radiogroup" aria-label="Match making mode" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {([
                ...
                { value: 'club_raid', label: 'Club Raid', badge: initialSettings.matchingMode === 'club_raid' ? 'ACTIVE' : null, desc: 'Multiple clubs compete in round-robin matches. Always cross-club play.' },
